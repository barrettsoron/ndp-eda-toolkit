# Email: Surveillance Pricing Asset Package — To Chapter Leads

**From:** Vancouver Centre NDP / [Your name]
**To:** Chapter leads
**Subject:** NDP petition on surveillance pricing — assets you can use independently
...
- **Paper petition** — printable, 2 per page. Collects name, address, postal code, email, and phone. Good for farmers markets, canvassing, community events, or any table opportunity.
- **Canvasser guide** — plain-language talking points, common objections and responses, and instructions for handling signed petitions.
- **Fact sheet** — leave-behind or table handout explaining what surveillance pricing is, who it hurts, and what the NDP is calling for.
- **Social copy** — short, medium, and long versions ready to post on your EDA's social accounts.
...
**Petition returns:** If you collect signed paper petitions, please arrange to return them to your chapter lead or bring them to the next VCNDP event. If you're collecting email addresses, those should be entered into the NDP database by an authorized person — do not store personal data on personal devices.

Feel free to adapt anything here for your own community or for allied organizations you're already in contact with — tenant groups, labour councils, community centres, wherever this issue resonates.
