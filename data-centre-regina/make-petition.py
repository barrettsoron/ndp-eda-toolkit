...
def draw_form(c, top_y):
    ...
    stmt = (
        ...
        '\u2014 starting with Bell Canada\u2019s proposed 300 MW campus outside Regina \u2014 '
        'until meaningful community consultation, environmental assessment, and democratic oversight '
        'have taken place. Our energy, our water, and our data sovereignty must serve Canadians first.\u201d'
    )
    rule_x    = MARGIN + BASE
    text_x    = rule_x + BASE
    ...
    c.drawString(MARGIN, footer_y + 9,
        'Return signed forms to your chapter lead or any Regina\u2013Wascana NDP event.')
